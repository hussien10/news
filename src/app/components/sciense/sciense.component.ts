...
@Component({
  selector: 'app-sciense',
  templateUrl: './sciense.component.html',
  styleUrls: ['./sciense.component.css']
})
export class ScienseComponent implements OnInit, OnDestroy {
  ...
  getdata(loc: string) {
    this.mysub = this.ns.getnews("science").subscribe(
      result => {
